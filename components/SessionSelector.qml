            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    MultiEffect {
                        ...
                        colorization: 1
                        colorizationColor: index === selector.currentSessionIndex || itemMouseArea.containsMouse ? colors.crust : colors.text
                        antialiasing: true
                    }
                }
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        text: name
                        color: index === selector.currentSessionIndex || itemMouseArea.containsMouse ? colors.crust : colors.text
                        font.pixelSize: 12
